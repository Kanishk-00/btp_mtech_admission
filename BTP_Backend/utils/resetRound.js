...
async function resetRound(inputRoundNumber){
    ...
    var filePaths=[`${userFilePath}/roundUpdates/round${roundNumber}_ConsolidatedFile.xlsx`,
    ...
    try {
        const result=await con.query(`DELETE FROM applicationstatus WHERE (Offered="Y" and OfferedRound='${roundNumber}') 
