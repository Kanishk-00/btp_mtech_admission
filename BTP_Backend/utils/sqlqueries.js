...
*/
async function insertManyIntoTable(connection,tableName,columnNames,toBeInsertedValues) {
...
module.exports={createDataBase,connectToDatabase,createDataBase,insertManyIntoTable,createTable,selectQuery}