...
function FileUploader(props) {
    ...
    const handleDownload=()=>{
        axios
        .get(`${serverLink}/api/initialise/uploadedFile`, {
            responseType: 'blob',
          },{
          withCredentials: false,
          headers: {
    ...
    return (
        <div className='flex flex-col max-w-[800px] min-w-[80%] shadow-lg rounded-xl'>
            ...
            <div className='flex items-center flex-col h-[180px] gap-1'> 
                ...
                <p className='text-xl text-grey '>Hmm looks like you have already uploaded the file</p>
            </div>
            }
            </div>
            {!fileExists && file!=null && <Button variant='contained' startIcon={<FileUploadIcon/>} style={{margin:"auto",marginBottom:"5px"}} onClick={uploadFile}>Upload</Button>}
